...
<head>
    ...
    <title>Lomba Video Informatif</title>
</head>
        ...
        <div class="row my-5">
            ...
            <div class="col-lg-6 col-ms-12">
                <div class="event-title">
                    ...
                    <h4><b>Lomba Video Informatif</b></h4>
                    <h6>Berkreasi dengan Penuh Kreatifitas di Era Teknologi</h6>
                </div>
                ...
                <div class="registrasi-button">
                    <a class="btn btn-lg btn-primary px-3 py-2" href="https://bit.ly/RegistrasiBluefestVI" role="button">
                        Daftar
                    </a>
                </div>
            </div>
