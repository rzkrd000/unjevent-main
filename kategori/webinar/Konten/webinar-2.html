            ...
            <div class="col-lg-6 col-ms-12">
                <div class="event-title">
                    ...
                    <div class="mt-2 mb-3 text-center">
                        <small><a href="#" class="text-decoration-none text-muted">23 September 2021</a></small>
                    </div>
                    <h4><b>K-TALKS 2021</b></h4>
                    <h6>Peran BMT dalam Meningkatkan Inklusi Keuangan untuk Pemulihan Ekonomi Indonesia</h6>
                </div>
                ...
                <div class="registrasi-button">
                    <a class="btn btn-lg btn-primary px-3 py-2" href="https://bit.ly/RegistrasiKTALKS2021" role="button">
                        Daftar
                    </a>
                </div>
            </div>
