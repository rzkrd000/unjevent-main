            ...
            <div class="col-lg-6 col-ms-12">
                <div class="event-title">
                    ...
                    <div class="mt-2 mb-3 text-center">
                        <small><a href="#" class="text-decoration-none text-muted">10 Oktober 2021</a></small>
                    </div>
                    <h4><b>Seminar Nasional BIOLEAF 2021</b></h4>
                    <h6>ECO-Change: The Crisis of Climate Change and the Utilization of Eco Enzyme for the Environment</h6>
                </div>
                ...
                <div class="registrasi-button">
                    <a class="btn btn-lg btn-primary px-3 py-2" href="https://bit.ly/PendaftaranSeminarBioleafUNJ2021" role="button">
                        Daftar
                    </a>
                </div>
            </div>
