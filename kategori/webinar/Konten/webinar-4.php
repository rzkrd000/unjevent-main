...
<head>
    ...
    <title>Seminar Sosialisasi Sukses PKM dan MAWAPRES Tata Busana 2021</title>
</head>
            ...
            <div class="col-lg-6 col-ms-12">
                <div class="event-title">
                    <div class="event-categories text-center">
                        <a href="" class="btn btn-primary btn-sm px-4 py-0">Webinar</a>
                    </div>
                    <div class="mt-2 mb-3 text-center">
                        <small><a href="#" class="text-decoration-none text-muted">11 September 2021</a></small>
                    </div>
                    <h4><b>Seminar Sosialisasi Sukses PKM dan MAWAPRES Tata Busana 2021</b></h4>
                    <h6>The Secret of Success for the Next Pimnas Champion and Outstanding Students at the National Level</h6>
                </div>
                ...
                <div class="registrasi-button">
                    <a class="btn btn-lg btn-primary px-3 py-2" href="https://bit.ly/PendaftaranKalimahAkbar2021" role="button">
                        Daftar
                    </a>
                </div>
            </div>
