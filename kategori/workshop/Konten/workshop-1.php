...
<head>
    ...
    <title>Workshop IT EXPO 2021</title>
</head>
            ...
            <div class="col-lg-6 col-ms-12">
                <div class="event-title">
                    <div class="event-categories text-center">
                        <a href="" class="btn btn-primary btn-sm px-4 py-0">Workshop</a>
                    </div>
                    <div class="mt-2 mb-3 text-center">
                        <small><a href="#" class="text-decoration-none text-muted">20 Oktober 2021</a></small>
                    </div>
                    <h4><b>WORKSHOP IT EXPO 2021</b></h4>
                    <h6>Digital Information for Business Strategy in Pandemic</h6>
                </div>
                ...
                <div class="registrasi-button">
                    <a class="btn btn-lg btn-primary px-3 py-2" href="https://www.itexpo-unj.com/" role="button">
                        Daftar
                    </a>
                </div>
            </div>
